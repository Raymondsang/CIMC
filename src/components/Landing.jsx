      ...
      <main className="flex-1 flex flex-col items-center px-4 md:px-8 py-6">
        <div className="max-w-6xl w-full">
          ...
          <motion.div
            ...
            className="relative bg-gray-800 rounded-xl overflow-hidden p-8 md:p-12 mb-8 text-white shadow-lg"
          >
            <div className="absolute inset-0 opacity-30 bg-gradient-to-r from-green-500 to-transparent"></div>
            ...
            <div className="relative z-10 text-center">
              ...
              <Link
                to="/SignIn"
                className="inline-flex items-center px-6 py-3 bg-green-600 text-white rounded-lg shadow-md hover:bg-green-700 transition-all w-full sm:w-auto"
              >
                Get Started
            ...
            >
              ...
              <ul className="space-y-4">
                {[1, 2].map((_, i) => (
                  ...
                  >
                    <div className="w-12 h-12 bg-green-100 flex items-center justify-center rounded-lg text-green-600 mr-4">
                      PDF
                    </div>
                    <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li
                    ...
                    className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors"
                  >
                    <div className="w-12 h-12 bg-green-100 flex items-center justify-center rounded-lg text-green-600">
                      {event.date}
                    </div>
